...
class motor_move():
    ...
    def body_trace_level(self,degree_level,degree_straight,error_level,error_straight) :
    ...
    try:    
        while not rospy.is_shutdown():
            if send.Web==True  :
                ...
                send.drawImageFunction(2,0,150,170,120,120,255,255,255)
                ...
                if step == "obs.search_to_ball":
                    ...
                    send.drawImageFunction(5,0,70,70,0,240,100,255,0)    #左
                    send.drawImageFunction(6,0,250,250,0,240,100,255,0)  # 右
                    send.drawImageFunction(7,0,0,320,180,180,0,0,0)  #白線界線
...
#===========================================================================================================================
                    ...
                    if abs(target.ball_x - 160) > 10  or abs(target.ball_y - 120) > 10 :
                        ...
                        elif abs(motor.head_vertical - kick_degree) > 5 : #1320是條球的距離150是誤差
